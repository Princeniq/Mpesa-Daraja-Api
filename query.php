...
$CheckoutRequestID = 'ws_CO_04032025010355562725640836';
...
if (isset($data_to->ResultCode)) {
  ...
  if ($ResultCode == '1037') {
    $massage = "Timeout in completing transaction Results code:1037";
  } elseif ($ResultCode == '1032') {
    $massage = "Transaction  has cancelled by user Results code:1032";
  } elseif ($ResultCode == '1') {
    $massage = "The balance is insufficient for the transaction Results code:1";
  } elseif ($ResultCode == '0') {
    $massage = "The transaction is successfully Results code:0";
  }
}
